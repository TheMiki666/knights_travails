...
puts "Testing get_last_square"
p i_love_paths[4].give_way
p i_love_paths[4].get_last_square #ok
p path.give_way
p path.get_last_square #ok

p another_paths[0].give_way
p another_paths[0].get_last_square #ok
